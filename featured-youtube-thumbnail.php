 ...
 * Plugin URI: http://d12themes.com/featured-youtube-thumbnail
 * Description: This plugin sets a youtube thumbnail as a featured image automatically.
 * Version: 1.0
 * Author: Chuy Sánchez
 * Author URI: http://d12themes.com
 * License: GPL2
 */

	/*  Copyright 2015  Chuy Sánchez  (email : jesusbet@gmail.com)
...
class YouTubeThumbnail
{
	...
	public function fyt_save_meta_box($post_id)
	{
		...
		$upload_file = wp_upload_bits($ytQuery['v'] . '_maxres.jpg', null, file_get_contents($ytImgUrl));
